...
# Читаем конфиг от Home Assistant (файл options.json создаётся автоматически)
...
# Копируем шаблон конфига, если его ещё нет
...
# Записываем пароль в отдельный файл passwd (как в оригинальной инструкции)
